...
<img src={require('./img/cloud-computing-impact-on-banking-sector.png').default} alt="cloud computing impact on banking sector" width="800" height="450"/>
<br/>
...
<img src={require('./img/cloud-computing-for-banking-1-300x300.png').default} alt="cloud computing for banking" width="400" height="300"/>
<br/>
