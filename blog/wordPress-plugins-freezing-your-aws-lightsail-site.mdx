...
<img src={require('./img/6365294.jpg').default} alt="Confused user illustration for WordPress stuck" width="500" height="400"/>
<br/>
...
<img src={require('./img/6567074.jpg').default} alt="User navigating steps to troubleshoot WordPress issues" width="500" height="400"/>
<br/>
...
<img src={require('./img/4936930.jpg').default} alt="Checking if site loads correctly" width="500" height="400"/>
<br/>
