...
<img src={require('./img/Hybrid-Cloud-Deployment-768x551.jpg').default} alt="Hybrid Cloud Deployment" width="400" height="250"/>
<br/>
...
<img src={require('./img/hybrid-cloud-computing1.png').default} alt="hybrid cloud computing" width="600" height="250"/>
<br/>
