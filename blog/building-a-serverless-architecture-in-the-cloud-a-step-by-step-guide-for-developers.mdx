...
<img src={require('./img/serverless-architecture.png').default} alt="cloud computing for developers" width="400" height="500"/>
<br/>
...
<img src={require('./img/right-cloud-provider-300x270.png').default} alt="right cloud provider" width="400" height="350"/>
<br/>
...
<img src={require('./img/coding-300x297.png').default} alt="coding" width="400" height="350"/>
<br/>
...
<img src={require('./img/cloud-computing-platform-768x286.png').default} alt="cloud computing platform" width="500" height="250"/>
<br/>
