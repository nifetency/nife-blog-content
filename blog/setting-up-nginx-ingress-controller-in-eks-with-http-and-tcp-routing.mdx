...
<img src={require('./img/5217215.jpg').default} alt="Illustration of a confused man and woman surrounded by question marks, representing the question: Why Use Ingress in EKS?" width="550" height="500"/>
<br/>
...
<img src={require('./img/9907646.jpg').default} alt="Illustration of Person with wrench and gear symbolizing NGINX Ingress Controller installation via Helm " width="550" height="500"/>
<br/>
...
<img src={require('./img/6030573.jpg').default} alt="Person configuring website DNS settings on a large screen, representing DNS setup in Cloudflare" width="600" height="500"/>
<br/>
