...
<img src={require('./img/release-management-for-startups-768x467.jpg').default} alt="release management for startups" width="500" height="300"/>
<br/>
...
<img src={require('./img/DevOps-tools--768x502.png').default} alt="release management for startups" width="800" height="400"/>
<br/>
