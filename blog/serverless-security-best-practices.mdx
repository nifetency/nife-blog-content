...
<img src={require('./img/Serverless-Security-768x508.png').default} alt="Serverless Security" width="400" height="250"/>
<br/>
...
<img src={require('./img/serverless-security--768x506.png').default} alt="serverless security" width="400" height="250"/>
<br/>
...
<img src={require('./img/serverless-computings.png').default} alt="serverless computing" width="400" height="350"/>
<br/>
