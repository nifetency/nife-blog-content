...
<img src={require('./img/7718877.jpg').default} alt="Illustration of Bitnami app stack architecture: person examining question mark." width="500" height="450"/>
<br/>
...
<img src={require('./img/11138.jpg').default} alt="Illustration of Bitnami app deployment: people interacting with a computer displaying 70% progress, symbolizing deployment across local, cloud, and containers. " width="500" height="450"/>
<br/>
...
<img src={require('./img/11224199.jpg').default} alt="Illustration of developer-friendly app deployment with Bitnami: person checking off items on a clipboard with a large checkmark above." width="500" height="450"/>
<br/>
