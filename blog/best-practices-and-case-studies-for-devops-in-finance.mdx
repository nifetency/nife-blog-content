...
<img src={require('./img/DevOps-in-Finance-768x430.png').default} alt="DevOps in Finance" width="400" height="250"/>
<br/>
...
<img src={require('./img/DevOps-in-Finance-768x430.png').default} alt="DevOps for Financial Services" width="400" height="250"/>
<br/>
