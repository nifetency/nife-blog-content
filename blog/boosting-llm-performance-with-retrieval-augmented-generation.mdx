...
<img src={require('./img/10235204.jpg').default} alt="Illustration of people discussing what RAG is" width="600" height="450"/>
<br/>
...
<img src={require('./img/20943637.jpg').default} alt="Illustration showing components of a RAG system" width="600" height="450"/>
<br/>
...
<img src={require('./img/10735306.jpg').default} alt="Illustration showing best practices for using RAG" width="600" height="450"/>
<br/>
