...
<img src={require('./img/build-automation-software-768x371.png').default} alt="build automation software" width="500" height="300"/>
<br/>
...
<img src={require('./img/DevOps-Automation-1.png').default} alt="DevOps Automation" width="500" height="300"/>
<br/>
