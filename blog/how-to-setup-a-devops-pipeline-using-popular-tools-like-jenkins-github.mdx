...
<img src={require('./img/Advantages-of-using-GitHub-Actions-768x508.png').default} alt="Advantages of using GitHub Actions" width="400" height="250"/>
<br/>
...
<img src={require('./img/DevOps-Pipeline-768x508.png').default} alt="DevOps Pipeline" width="400" height="250"/>
<br/>
