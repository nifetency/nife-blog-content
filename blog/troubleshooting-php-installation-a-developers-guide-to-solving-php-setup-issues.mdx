...
<img src={require('./img/3857425.jpg').default} alt="Illustration showing components of a PHP setup including PHP binary, php.ini file, extensions, PHP-FPM, and web server" width="500" height="450"/>
<br/>
...
<img src={require('./img/6106299.jpg').default} alt="Visual representation of PHP installation on different operating systems including Ubuntu, CentOS, and macOS" width="500" height="450"/>
<br/>
...
<img src={require('./img/3891942.jpg').default} alt="Conceptual image representing successful PHP setup and troubleshooting completion" width="500" height="450"/>
<br/>
