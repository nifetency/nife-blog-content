...
<img src={require('./img/6943381.jpg').default} alt="Illustration of confused person about S3" width="600" height="500"/>
<br/>
...
<img src={require('./img/20944573.jpg').default} alt="Illustration of bucket policy security" width="600" height="500"/>
<br/>
...
<img src={require('./img/4630062.jpg').default} alt="Illustration of team working on ACL file access" width="600" height="500"/>
<br/>
