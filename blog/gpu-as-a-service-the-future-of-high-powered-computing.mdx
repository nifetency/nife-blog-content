...
- **Amazon Web Services (AWS) - EC2 GPU Instances**: includes deep learning and AI-optimized [NVIDIA A10G](https://aws.amazon.com/ec2/instance-types/g5/), A100, and Tesla GPUs. use [Nitro Hypervisor](https://aws.amazon.com/ec2/nitro/) to maximize virtualization performance.
