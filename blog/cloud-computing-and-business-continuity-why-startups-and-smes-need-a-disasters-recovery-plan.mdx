...
<img src={require('./img/cloud-computing-for-startups-300x197.png').default} alt="cloud computing for startups" width="400" height="250"/>
<br/>
...
<img src={require('./img/cloud-disaster-recovery-300x156.png').default} alt="cloud disaster recovery" width="400" height="250"/>
<br/>
...
<img src={require('./img/backup-recovery--300x111.png').default} alt="cloud backup recovery" width="400" height="150"/>
<br/>
...
<img src={require('./img/business-continuity-and-disaster-recovery-in-cloud-computing-300x201.png').default} alt="business continuity and disaster recovery in cloud computing" width="400" height="250"/>
<br/>
