...
<img src={require ('./img/10306562.jpg').default} alt="Illustration of Amazon Cognito features like user sign-up, login options, and secure access" width="500" height="400"/>
<br/>
...
<img src={require ('./img/20945218.jpg').default} alt="Diagram showing how Amazon Cognito User Pools and Identity Pools manage authentication and AWS access" width="500" height="400"/>
<br/>
