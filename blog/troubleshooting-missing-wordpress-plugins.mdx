...
<img src={require('./img/3819454.jpg').default} alt="Illustration of a website under construction with a person painting and a robotic arm placing an image" width="700" height="450"/>
<br/>
...
<img src={require('./img/6664783.jpg').default} alt="Illustration of developers debugging code, with one person using a magnifying glass to find bugs on a large screen." width="700" height="550"/>
<br/>
...
<img src={require('./img/6029646.jpg').default} alt="Illustration of a technician holding a wrench, fixing a system error displayed on a laptop screen" width="700" height="450"/>
<br/>
