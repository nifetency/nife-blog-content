...
<img src={require('./img/Cloud-computing-companies-768x351.jpg').default} alt="Cloud computing companies" width="400" height="250"/>
<br/>
...
<img src={require('./img/Cloud-Computing-Technology-768x512.jpg').default} alt="cloud computing technology" width="400" height="250"/>
<br/>
...
<img src={require('./img/multi-access-edge-computing-768x432.jpg').default} alt="multi-access-edge-computing" width="400" height="250"/>
<br/>
...
<img src={require('./img/Cloud-computing-platforms-768x268.jpg').default} alt="Cloud computing platforms" width="600" height="250"/>
<br/>
