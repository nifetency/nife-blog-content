...
<img src={require('./img/devops-as-a-service-1.jpg').default} alt="DevOps as a Service" width="500" height="250"/>
<br/>
...
<img src={require('./img/AWS-Codeline-768x276.jpg').default} alt="AWS CodeBuild" width="600" height="200"/>
<br/>
...
<img src={require('./img/Google-Cloud-DevOps-768x290.jpg').default} alt="Google Cloud DevOps" width="600" height="250"/>
<br/>
