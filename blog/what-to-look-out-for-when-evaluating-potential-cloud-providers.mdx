...
<img src={require('./img/wp-content-uploads-2022-09-cloud-service-providers-300x150.jpg').default} alt="cloud service providers" width="500" height="300"/>
<br/>
...
<img src={require('./img/Google-Cloud-Services-300x114.png').default} alt="cloud service providers" width="500" height="300"/>
<br/>
...
<img src={require('./img/best-Cloud-Company-platform-300x219.jpg').default} alt="best Cloud Company platforms" width="500" height="300"/>
<br/>
