...
<img src={require('./img/Testing-and-Security-in-DevOps-768x403.png').default} alt="Testing and Security in DevOps" width="500" height="250"/>
<br/>
...
<img src={require('./img/DevOps-Security-768x508.png').default} alt="DevOps Security" width="500" height="290"/>
<br/>
