...
<img src={require('./img/5g-network-768x512.jpg').default} alt="5g network" width="400" height="250"/>
<br/>
...
<img src={require('./img/5G-and-Slicing-2-scaled.jpg').default} alt="Network Slicing and Cloud Computing" width="800" height="600"/>
<br/>
