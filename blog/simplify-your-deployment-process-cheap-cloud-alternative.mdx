...
<img src={require('./img/cloud-deployment-768x413.jpg').default} alt="cloud-deployment-768x413.jpg" width="400" height="250"/>
<br/>
...
<img src={require('./img/PaaS-provider-Nife-768x384.jpg').default} alt="PaaS provider Nife" width="400" height="250"/>
<br/>
...
<img src={require('./img/best-Cloud-Company-in-Singapore-768x378.jpg').default} alt="best Cloud Company in Singapore" width="500" height="250"/>
<br/>
