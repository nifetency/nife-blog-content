...
<img src={require('./img/Cloud-Deployment-Models-768x401.jpg').default} alt="Cloud Deployment Models" width="400" height="250"/>
<br/>
...
<img src={require('./img/cloud-data-security-768x390.jpg').default} alt="cloud data security" width="400" height="250"/>
<br/>
...
<img src={require('./img/Cloud-deployment-models-in-cloud-computing-768x393.jpg').default} alt="Cloud deployment models in cloud computing" width="400" height="250"/>
<br/>
