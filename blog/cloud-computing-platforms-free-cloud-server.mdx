...
<img src={require('./img/best-cloud-servers-300x225.jpg').default} alt="best cloud servers" width="400" height="250"/>
<br/>
...
<img src={require('./img/cloud-budget.jpg').default} alt="cloud budget" width="400" height="250"/>
<br/>
