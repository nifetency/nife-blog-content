...
<img src={require('./img/hybrid-cloud-computing-for-financial-services-768x388.png').default} alt="hybrid cloud computing for financial services" width="450" height="250"/>
<br/>
...
<img src={require('./img/scaling-financial-services-applications.png').default} alt="scaling financial services applications" width="600" height="250"/>
<br/>
...
<img src={require('./img/cloud-cost-optimisation-768x508.png').default} alt="cloud cost optimizations" width="400" height="250"/>
<br/>
...
<img src={require('./img/risk-management-in-cloud-computing-768x452.png').default} alt="risk management in cloud computing" width="400" height="250"/>
<br/>
